...
class TokenProviderTest {
    ...
    @BeforeEach
    void setup() {
        this.userDetails = new User("superadmin", "12345", Collections.singletonList(new SimpleGrantedAuthority("SUPERADMIN")));
    ...
    void getUsernameFromToken() {
        ...
        assertEquals("superadmin", tokenProvider.getUsernameFromToken(this.token));
    }
